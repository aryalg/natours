    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error! Logginng out! Try again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmlrcmFtYXJ5YWwiLCJhIjoiY2szY2tvMDV6MHd5MDNqcWo4Zzd2dWlqZyJ9.YuAr6_Ge09NzVQ1-8jw24w';
...
/* eslint-disable */
var stripe = Stripe('pk_test_iWH9W6REc0NWAYWgsr6mzAk200pbbAjbHz');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(session); //  2) Create chcekout form + charge credit card
